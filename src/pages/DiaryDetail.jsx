      ...
      <div className="container flex items-center flex-col pb-20 min-h-[674px] overflow-x-hidden">
        <div className="flex justify-between w-full px-5">
          ...
          <div className="flex items-center gap-2">
            <Link to={`../dashboard/edit/${id}`} className="text-white bg-gray-800 border border-transparent hover:bg-gray-900 focus:ring-4 focus:ring-gray-300 disabled:hover:bg-gray-800 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-800 dark:border-gray-700 dark:disabled:hover:bg-gray-800 group flex h-min items-center justify-center text-center font-medium focus:z-10 rounded-lg p-[1px]"><FontAwesomeIcon icon={faEdit} className="px-4 py-2"/></Link>
            <Button color="dark" onClick={() => deleteDiaryById(id)}><FontAwesomeIcon icon={faTrashCan}/></Button>
          </div>
        </div>
